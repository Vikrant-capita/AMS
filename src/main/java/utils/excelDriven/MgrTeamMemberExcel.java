...
public class MgrTeamMemberExcel {

	public  ArrayList<String> getData(String testcaseName, String coloumnName,String sheetName) throws IOException {
		// fileInputStream argument
		ArrayList<String> a = new ArrayList<String>();

		FileInputStream fis = new FileInputStream(
		System.getProperty("user.dir") + "\\src\\test\\java\\resources\\Manager Testdata.xlsx");
